...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice skills and play matches with the school soccer squad",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve stroke technique and endurance in the school pool",
        "schedule": "Mondays, Wednesdays, 5:00 PM - 6:30 PM",
        "max_participants": 20,
        "participants": ["ava@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse scenes, develop characters, and perform plays",
    ...
    "Science Exploration": {
        "description": "Run experiments, study new discoveries, and discuss science topics",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
